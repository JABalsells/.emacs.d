...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jupyter-client" '("comm-" "define-jupyter-client-handler" "input-request" "jupyter-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jupyter-kernel" '("jupyter-kernel-name")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jupyter-kernel-process" '("jupyter-")))
...
sync with those specified on your system or notebook server." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jupyter-monads" '("jupyter-")))
...
Toggle on or off client side queuing." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jupyter-server-kernel" '("jupyter-")))
