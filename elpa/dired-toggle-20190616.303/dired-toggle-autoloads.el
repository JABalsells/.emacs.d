...
Quit action under `dired-toggle-mode'." t nil)
...
`dired-hide-details-mode' states after opening new direcoty." t nil)
...
and `dired-hide-details-mode' states after opening new direcoty." t nil)
