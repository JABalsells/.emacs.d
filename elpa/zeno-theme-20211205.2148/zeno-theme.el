...
(defcustom zeno-theme-enable-italics nil
  ...
  :type 'boolean
  :group 'zeno-theme)
; old seperator was #1F2029, I matched to bg
(let
    (
     (bg                     "#282A36")
     (fg                     "#E8F0FF")
...
(custom-theme-set-faces
 ...
 ;; diredfl
 `(diredfl-dir-heading ((t (:background ,bg :foreground ,fg))))
 `(diredfl-dir-name ((t (:background ,bg :foreground ,atlantis-green))))
 `(diredfl-file-name ((t (:foreground ,maya-blue))))
 `(diredfl-file-suffix ((t (:foreground ,kimberly))))
 `(diredfl-ignored-file-name ((t (:foreground ,maya-blue))))
